...
divXpos.style.backgroundColor = "rgb(154,169,246)";
divXpos.innerText = "Cool stuff happens here!";

// 4 - WEST
divXneg.className = "cssContent";
divXneg.style.backgroundColor = "rgb(251, 247, 14)";
divXneg.innerText = "Even more cool stuff!";

// for Y : COMMENTED OUT, NO NEED FOR UP/DOWN YET 
// divYpos.className = "cssContent";
// divYpos.style.backgroundColor = "blue";
// divYpos.innerText = "Pos Y = Up";

// TESTING/CALIBRATING PURPOSES
divYneg.className = "cssContent";
divYneg.style.backgroundColor = "red";
divYneg.innerText = "this should be down";

//for Z
// 3 - SOUTH
divZpos.className = "cssContent";
divZpos.style.backgroundColor = "rgb(222, 140, 185)";
divZpos.innerText = "More cool things happen here!";

// 1 - NORTH 
divZneg.className = "cssContent";
divZneg.style.backgroundColor = "rgb(150,199,160)";
divZneg.innerText = "Welcome to the Michigan Information Interaction lab!";
